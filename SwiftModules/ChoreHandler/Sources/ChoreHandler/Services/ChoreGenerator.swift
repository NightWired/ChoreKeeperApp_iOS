...
/// Implementation of the ChoreGeneratorProtocol
public class ChoreGenerator: ChoreGeneratorProtocol {
    // MARK: - Properties
    ...
    /// Creates a new chore generator
    /// - Parameter choreScheduler: The chore scheduler to use
    public init(choreScheduler: ChoreSchedulerProtocol = ChoreScheduler()) {
    ...
    public func generateChoreInstances(
        ...
        for dueDate in dueDates {
            let id = Int64(dueDate.timeIntervalSince1970)
